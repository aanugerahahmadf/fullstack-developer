...
export declare function refresh(currentUrl: URL, currentFlightRouterState: FlightRouterState, currentNextUrl: string | null, currentRenderedSearch: string, currentCanonicalUrl: string): SuccessfulNavigationResult | NoOpNavigationResult | MPANavigationResult;
export {};
