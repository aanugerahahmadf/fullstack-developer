...
export function startPPRNavigation(navigatedAt, oldUrl, oldCacheNode, oldRouterState, newRouterState, prefetchData, prefetchHead, isPrefetchHeadPartial, isSamePageNavigation, accumulation) {
    const segmentPath = [];
...
export function startPPRRefresh(navigatedAt, currentRouterState, currentNextUrl, accumulation) {
...
function createCacheNodeOnNavigation(isRefresh, parentRefreshUrl, navigatedAt, routerState, existingCacheNode, prefetchData, possiblyPartialPrefetchHead, isPrefetchHeadPartial, segmentPath, accumulation) {
    ...
    if (isRefresh) {
        ...
        refreshUrl = typeof href === 'string' && routerState[3] === 'refresh' ? // refresh URL as we continue traversing the tree.
...
export function listenForDynamicRequest(url, nextUrl, task, dynamicRequestTree, existingDynamicRequestPromise, accumulation) {
